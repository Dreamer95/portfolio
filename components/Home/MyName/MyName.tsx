...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    <div
      ...
      px-8 2xl:px-72 xl:px-56 lg:px-32  md:px-28 sm:px-8 pb-14 pt-20 sm:pb-28 sm:pt-32"
    >
      <motion.span
      ...
      >
        ...
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">Loyalty domain</span>,
        where I actively engage in developing <br className="2xl:block hidden"/>
        and designing immersive <span className="text-AAsecondary">Gamification applications</span>. This involves working with some{" "}
        <span className="text-AAsecondary">awesome libraries</span>  like{" "}
        <span className="text-AAsecondary">Framer-motion, Ant design, React-query,... </span>
