      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/Dreamer95"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/dongdn195/"} />
            {/* Instagram Icon */}
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:dongdn195@gmail.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                dongdn195<span className="text-AAsecondary">@</span>gmail.com<span className="text-AAsecondary">.</span>com
              </span>
            </a>
          </motion.div>
