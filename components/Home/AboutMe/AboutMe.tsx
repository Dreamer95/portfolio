...
const myImage = cld.image('IMG_7275_mhu8dy');

// Resize to 250 x 250 pixels using the 'fill' crop mode.
myImage.resize(fill().width(800).height(800));

export default function AboutMe(props) {
  const technologies = [
    ["React.js / Next.js", "React Native", "Tailwind CSS", "Docker", "Webpack"],
    ["Nest.js", "TypeScript", "Framer Motion", "Golang", "MySql"],
  ];
  return (
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Ngoc Dong, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet. My journey in computer science began in 2013 when
                I was accepted into the University of Information Technology. Little did I know that programming skills
            ...
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                <span className="text-AAsecondary">Gamification</span>, I am dedicated to pushing boundaries and driving
                advancements. With experience working alongside esteemed organizations like{" "}
                <span className="text-AAsecondary">One Mount Group</span>, where I played a role in releasing some Gami concepts on{" "}
                <span className="text-AAsecondary">VinID, VinShop</span> , my passion for web development and continuous
          ...
          <div className="group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden ">
            ...
            <div className="absolute w-5/6 h-5/6  rounded overflow-hidden">
              ...
              {/*/>*/}
              {/*<AdvancedImage className={"object-contain rounded-lg"} cldImg={myImage} />*/}
              <CloudImage publicId={'IMG_7275_mhu8dy'} width={800} height={800} />
            </div>
          </div>
          {/* // ?Image in Mobile */}
