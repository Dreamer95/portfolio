...
export default function Home() {
  ...
  const [IsBlackListEmpty, setIsBlackListEmpty] = useState(true);
  ...
  const meta = {
    title: "Ngoc Dong - Software Engineer",
    description: `I've been working on Software development for 5 years straight. Get in touch with me to know more.`,
    image: "https://res.cloudinary.com/dhpan0ekv/image/upload/c_fill,h_750,w_750/v1716995137/IMG_7275_mhu8dy.jpg",
    type: "website",
  };
  ...
  return (
    <>
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory overflow-x-hidden min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/Dreamer95"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
